...
export function ExpenseItem({ id, icon, iconUrl, title, amount, currencySymbol, spentAt, category, color, note, onDelete, onClick, onMoveUp, onMoveDown, index, totalItems }) {
